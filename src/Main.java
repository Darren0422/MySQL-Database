...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // Various int variables to allow for the switch statements to navigate the menus and its corresponding function
            Scanner scanner = new Scanner(System.in);
            int choice;

            int addChoice;
            // the .getLastIdFrom'table_name' function is called to obtain the last ID for the primary key in each table (used to assist in populating the tables when records are added)
                        ...
                        case 2:
                            ...
                            switch (updateChoice) {
                                case 1:
                                    ...
                                    // Switch statement to display the various aspects the user can add with regards to the project (update entire the entire project or mark the project as completed)
                                    // Users enters the number of their choice 
                        ...
                        case 4:
                            ...
                            switch (searchChoice) {
                                case 1:
                                    ...
                                    // Switch statement to display the various aspects the user can search regarding the project (search by project ID, name, ongoing projects or projects past the due date)
                                    // Users enters the number of their choice 
                                ...
                                case 2:
                                    ...
                                    // Switch statement to display the various aspects the user can search regarding the architect (search by ID or name)
                                    // Users enters the number of their choice 
                                ...
                                case 3:
                                    ...
                                    // Switch statement to display the various aspects the user can search regarding the contractor (search by ID or name)
                                    // Users enters the number of their choice 
                                ...
                                case 4:
                                    ...
                                    // Switch statement to display the various aspects the user can search regarding the customer (search by ID or name)
                                    // Users enters the number of their choice 
    ...
    public static void updateProject(Statement statement, int lastProjectId, Scanner scanner) {
        try {
            ...
            // IF the project name is empty, getCustomerSurname function is called to obtain the relevant customer surname and appends it to the building type to create a name for the project
